...
const STRINGS: Record<string, LS> = {
  ...
  // named routines
  routines_head: { zh: "我的按摩方案", en: "My routines" },
  routines_empty: {
    zh: "還沒有方案。建立自己的按摩順序,或先套用下面的示範方案。",
    en: "No routines yet. Build your own press sequence, or start from a preset below.",
  },
  routine_new: { zh: "＋ 新增方案", en: "＋ New routine" },
  routine_name_ph: { zh: "方案名稱(例:睡前放鬆)", en: "Routine name (e.g. wind-down)" },
  routine_create: { zh: "建立", en: "Create" },
  routine_cancel: { zh: "取消", en: "Cancel" },
  routine_start: { zh: "▶ 開始", en: "▶ Start" },
  routine_edit: { zh: "✎ 編輯", en: "✎ Edit" },
  routine_edit_done: { zh: "完成", en: "Done" },
  routine_delete: { zh: "刪除", en: "Delete" },
  routine_delete_confirm: { zh: "確定刪除?", en: "Really delete?" },
  routine_points_n: { zh: "{n} 個穴位", en: "{n} points" },
  routine_rename_save: { zh: "儲存名稱", en: "Save name" },
  routine_no_points: {
    zh: "這組還沒有穴位,從下面收藏或搜尋加入。",
    en: "No points yet — add some from your saved points or the search below.",
  },
  routine_add_from_fav: { zh: "從收藏加入", en: "Add from saved" },
  routine_search_ph: { zh: "搜尋穴位加入…", en: "Search points to add…" },
  routine_move_up: { zh: "上移", en: "Move up" },
  routine_move_down: { zh: "下移", en: "Move down" },
  routine_remove_point: { zh: "移除", en: "Remove" },
  routine_presets_head: { zh: "示範方案(一鍵套用)", en: "Starter routines (one-tap add)" },
  routine_apply: { zh: "＋ 套用", en: "＋ Add" },

  // point card → add to routine
  add_to_routine: { zh: "＋ 加入方案", en: "＋ Add to routine" },
  added_to_routine: { zh: "✓ 已加入「{name}」", en: "✓ Added to “{name}”" },
  already_in_routine: { zh: "已在「{name}」", en: "Already in “{name}”" },
  new_routine_with_point: { zh: "＋ 建立新方案…", en: "＋ New routine…" },
  no_routine_yet_hint: {
    zh: "還沒有方案,先建立一組:",
    en: "No routines yet — create one:",
  },
