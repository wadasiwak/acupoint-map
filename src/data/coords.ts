...
export const COORDS: Record<string, PointCoords> = {
  ...
  // --- neck-shoulder ---
  jianjing: { overview: { view: "back", x: 142, y: 82 }, detail: { view: "back-upper", x: 158, y: 76 } },
  dazhui: { overview: { view: "back", x: 120, y: 74 }, detail: { view: "back-upper", x: 120, y: 70 } },
  tianzhu: { overview: { view: "back", x: 114, y: 66 }, detail: { view: "back-upper", x: 112, y: 40 } },
  jianyu: { overview: { view: "front", x: 158, y: 94 }, detail: { view: "torso-front", x: 198, y: 54 } },
  tianzong: { overview: { view: "back", x: 140, y: 124 }, detail: { view: "back-upper", x: 150, y: 128 } },
  gaohuang: { overview: { view: "back", x: 134, y: 116 }, detail: { view: "back-upper", x: 146, y: 118 } },

  // --- torso ---
  feishu: { overview: { view: "back", x: 130, y: 108 }, detail: { view: "back-upper", x: 133, y: 106 } },
  shenshu: { overview: { view: "back", x: 130, y: 196 }, detail: { view: "back-lower", x: 133, y: 88 } },
  mingmen: { overview: { view: "back", x: 120, y: 196 }, detail: { view: "back-lower", x: 120, y: 88 } },
  ciliao: { overview: { view: "back", x: 126, y: 226 }, detail: { view: "back-lower", x: 125, y: 170 } },
  danzhong: { overview: { view: "front", x: 120, y: 126 }, detail: { view: "torso-front", x: 120, y: 108 } },
  zhongwan: { overview: { view: "front", x: 120, y: 158 }, detail: { view: "torso-front", x: 120, y: 166 } },
  shuifen: { overview: { view: "front", x: 120, y: 178 }, detail: { view: "torso-front", x: 120, y: 192 } },
  tianshu: { overview: { view: "front", x: 133, y: 188 }, detail: { view: "torso-front", x: 137, y: 200 } },
  qihai: { overview: { view: "front", x: 120, y: 200 }, detail: { view: "torso-front", x: 120, y: 215 } },
  guanyuan: { overview: { view: "front", x: 120, y: 212 }, detail: { view: "torso-front", x: 120, y: 230 } },
  zhongji: { overview: { view: "front", x: 120, y: 222 }, detail: { view: "torso-front", x: 120, y: 240 } },
  qimen: { overview: { view: "front", x: 135, y: 140 }, detail: { view: "torso-front", x: 142, y: 150 } },

  // --- arm & hand (right side of figure) ---
  quchi: { overview: { view: "front", x: 188, y: 150 }, detail: { view: "elbow", x: 57, y: 74 } },
  chize: { overview: { view: "front", x: 178, y: 152 }, detail: { view: "elbow", x: 94, y: 74 } },
  shousanli: { overview: { view: "front", x: 191, y: 166 }, detail: { view: "elbow", x: 64, y: 104 } },
  ...
  liangqiu: { overview: { view: "front", x: 104, y: 322 }, detail: { view: "knee", x: 80, y: 80 } },
  xuehai: { overview: { view: "front", x: 114, y: 322 }, detail: { view: "knee", x: 121, y: 80 } },
  dubi: { overview: { view: "front", x: 108, y: 348 }, detail: { view: "knee", x: 83, y: 131 } },
  zusanli: { overview: { view: "front", x: 110, y: 366 }, detail: { view: "knee", x: 88, y: 176 } },
  yanglingquan: { overview: { view: "front", x: 100, y: 356 }, detail: { view: "knee", x: 70, y: 154 } },
  yinlingquan: { overview: { view: "front", x: 115, y: 358 }, detail: { view: "knee", x: 128, y: 152 } },
  diji: { overview: { view: "front", x: 113, y: 380 }, detail: { view: "lower-leg", x: 128, y: 104 } },
  fenglong: { overview: { view: "front", x: 106, y: 398 }, detail: { view: "lower-leg", x: 80, y: 136 } },
  xuanzhong: { overview: { view: "front", x: 99, y: 444 }, detail: { view: "lower-leg", x: 78, y: 214 } },
  ...
  weizhong: { overview: { view: "back", x: 104, y: 342 }, detail: { view: "leg-back", x: 100, y: 80 } },
  chengshan: { overview: { view: "back", x: 102, y: 392 }, detail: { view: "leg-back", x: 100, y: 176 } },
  kunlun: { overview: { view: "back", x: 99, y: 458 }, detail: { view: "leg-back", x: 115, y: 254 } },
};
